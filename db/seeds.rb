...
truck_3 = Truck.new(name: 'Yoga Flow 🧘‍♀️', category: 'Yoga', price: 190, description: 'Enjoy this unique Yoga class for a relaxed & zen attitude', user:User.first, address: "nice, france")
...
truck_4 = Truck.new(name: 'Dynamic Yoga 🧘‍♂️', category: 'Yoga', price: 150, description: 'A mix of traditional Yoga with a dynamic twist!', user:User.first, address: "244 hameau des veyans, le tignet")
...
truck_9 = Truck.new(name: 'Magic 🧙‍♂️', category: 'Kids', price: 90, description: 'Magician, rabbits and all kinds of tricks for the best Kids party ever!', user:User.first, address: "fontainebleau")
file = URI.open('https://img-a.udemycdn.com/course/750x422/867018_2300_2.jpg')
