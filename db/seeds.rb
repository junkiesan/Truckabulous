...
truck_2 = Truck.new(name: 'Sushi & Sashimi', category: 'Food', price: 200, description: 'Fresh fish for your sushi party!', user: melanie)
...
truck_8 = Truck.new(name: 'Burger Atelier', category: 'Food', price: 135, description: 'big burgers for hungry peoples !', user:User.first)
